...
export function FeaturesSectionDemo1() {
    return (
        <div className="">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5 md:gap-8 max-w-5xl mx-auto">
                {grid.map((feature) => (
                    <div
                        key={feature.title}
                        className="relative bg-gradient-to-b from-[#535EF9]/20 via-[#535EF9]/15 to-[#535EF9]/5 p-10 rounded-3xl overflow-hidden"
                    >
                        <Grid size={20} />
                        <RandomTextWrapper className="text-base font-bold text-neutral-800 relative z-20">
                            {feature.title}
                        </RandomTextWrapper>
                        <RandomTextWrapper className="text-neutral-600 mt-5 text-base font-normal relative z-20">
                            {feature.description}
                        </RandomTextWrapper>
                    </div>
                ))}
