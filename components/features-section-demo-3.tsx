      ...
      {/* <div className="flex flex-row -ml-20">
        {images.map((image, idx) => (
          <motion.div
            ...
            style={{ rotate: rotations[idx] || 0 }} // safe fallback
            whileHover="whileHover"
            whileTap="whileTap"
            className="rounded-xl -mr-4 mt-4 p-1 bg-white dark:bg-neutral-800 border border-neutral-100 dark:border-neutral-700 shrink-0 overflow-hidden"
          >
            <img
              src={image}
              alt="bali images"
        ...
        {images.map((image, idx) => (
          ...
          >
            <Image
              ...
              width={500}
              height={500}
              className="rounded-lg h-52 w-52 md:h-72 md:w-72 lg:h-96 lg:w-96 object-cover"
            />
          </motion.div>
        ))}
      </div>
